...
public class CircleDetailActivity extends AppCompatActivity {
    ...
    // 后端接口地址
    private static final String API_DETAIL = "http://192.168.172.1:8081/api/cuser/post_detail?postId=";
    private static final String API_COMMENTS = "http://192.168.172.1:8081/api/cuser/post_comments?postId=";
    private static final String API_ADD_COMMENT = "http://192.168.172.1:8081/api/cuser/add_comment";
