...
public class WMainActivity extends AppCompatActivity {
    ...
    private void setNavClickListener() {
        navCircle.setOnClickListener(v -> viewPager.setCurrentItem(0, true));
        navMessage.setOnClickListener(v -> viewPager.setCurrentItem(1, true));
        navProfile.setOnClickListener(v -> viewPager.setCurrentItem(2, true));
    }
