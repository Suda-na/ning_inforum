...
public class SPostController {
     ...
     */
    @PostMapping("/list")
    public Map<String, Object> getPostList(@RequestBody Map<String, Object> request) {
        Map<String, Object> response = new HashMap<>();
        
        try {
            Integer currentUserId = getInteger(request, "currentUserId");
            Integer categoryId = getInteger(request, "categoryId");
            String keyword = getString(request, "keyword");
            Integer trendingLevel = getInteger(request, "trendingLevel");
            String sortType = getString(request, "sortType");
            Integer page = getInteger(request, "page");
            Integer pageSize = getInteger(request, "pageSize");
            ...
            if (trendingLevel != null) {
                params.put("trendingLevel", trendingLevel);
            }
            ...
            List<SPostVO> posts = sPostService.getPostList(params);
            int total = sPostService.countPosts(params);
