...
public class WApiClient {
    ...
    private static final String BASE_URL = "http://192.168.243.1:8080"; // 根据实际情况修改
    ...
    public static ApiResponse post(String path, Map<String, String> params) {
        try {
            ...
            String responseStr = response.toString();
            Log.d(TAG, "POST响应原始数据: " + responseStr);
            ...
            Log.d(TAG, "POST响应解析: code=" + code + ", message=" + message + ", data类型=" + (data != null ? data.getClass().getName() : "null"));
