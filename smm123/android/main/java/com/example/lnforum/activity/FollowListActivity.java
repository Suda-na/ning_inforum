...
public class FollowListActivity extends AppCompatActivity {
    ...
    // ✅ 后端接口
    private static final String API_URL = "http://192.168.243.1:8080/api/cuser/relation_list";
    ...
    private void checkFollowStatuses(Integer myUserId) {
        ...
        for (CUser user : dataList) {
            ...
            String url = "http://192.168.243.1:8080/api/cuser/check_follow?userId=" + myUserId + "&targetUserId=" + targetUserId;
            Request request = new Request.Builder().url(url).get().build();
    ...
    private void performAction(Integer userId, Integer targetUserId, int actionType, int position) {
        ...
        String actionUrl = "http://192.168.243.1:8080/api/cuser/follow_action";
