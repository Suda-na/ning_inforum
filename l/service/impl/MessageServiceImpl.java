...
public class MessageServiceImpl implements MessageService {
    ...
    @Override
    public boolean addPrivateMessageByAdmin(Integer receiverId, String content, Integer msgFormat, String imageUrl) {
        try {
    ...
    @Override
    public void markPrivateMessagesAsRead(Integer userId) {
        if (userId == null) {
            return;
        }
        try {
