...
// private static final String UPLOAD_URL = "http://192.168.172.1:8081/api/cuser/upload_avatar";
    ...
    // 修改后 (正确)
    private static final String UPDATE_URL = "http://192.168.159.1:8080/api/cuser/update";
    private static final String UPLOAD_URL = "http://192.168.159.1:8080/api/cuser/upload_avatar";
