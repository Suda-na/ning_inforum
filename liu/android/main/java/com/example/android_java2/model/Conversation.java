...
public class Conversation {
    ...
    public Conversation(String id, String title, String lastMessage, long timestamp, String type, String avatar) {
        this(id, title, lastMessage, timestamp, type, avatar, 0);
    }
