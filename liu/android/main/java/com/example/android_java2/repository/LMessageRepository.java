...
public class LMessageRepository {
    ...
    private static final String BASE_URL = "http://192.168.159.1:8080";
    ...
    public static class ConversationResponse {
        ...
        private String messagePreview;   // 处理过的消息预览（包含"我:"前缀）
        private String lastMessageTime;
        private Integer unreadCount;
        private String avatar;           // 用户头像URL
        private Integer msgFormat;       // 消息格式：0文本，1图片
    ...
    public static void sendTextMessage(Context context, Integer receiverId, String content, SendMessageCallback callback) {
        ...
        client.newCall(request).enqueue(new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
                android.util.Log.e("LMessageRepository", "发送消息失败: " + e.getMessage());
                if (callback != null) {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    ...
                    if (code == 200) {
                        ...
                        String msg = message != null ? message : "发送失败";
                        if (callback != null) {
    ...
    public static void sendImageMessage(Context context, Integer receiverId, String imageUrl, String content, SendMessageCallback callback) {
        ...
        client.newCall(request).enqueue(new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
                android.util.Log.e("LMessageRepository", "发送图片消息失败: " + e.getMessage());
                if (callback != null) {
                    callback.onResult(false, "网络请求失败: " + e.getMessage());
                }
            }
    ...
    public static void getAllUnreadCounts(Context context, AllUnreadCountsCallback callback) {
        ...
        client.newCall(request).enqueue(new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
                android.util.Log.e("LMessageRepository", "获取未读数失败: " + e.getMessage());
                if (callback != null) {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    if (json.trim().startsWith("<")) {
                        android.util.Log.e("LMessageRepository", "服务器返回HTML而不是JSON");
                        if (callback != null) {
                            callback.onResult(0, 0, 0, 0, "服务器错误");
                        }
                        return;
                    }
                    ...
                    if (code == 200) {
                        ...
                        android.util.Log.d("LMessageRepository", "解析后的未读数 - total:" + total + ", mutualFollow:" + mutualFollow + ", fan:" + fan + ", admin:" + admin);
                        if (callback != null) {
